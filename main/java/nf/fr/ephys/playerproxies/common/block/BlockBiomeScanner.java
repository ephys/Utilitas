...
public class BlockBiomeScanner extends BlockContainer {
	...
	public static void register() {
		...
		GameRegistry.registerBlock(PlayerProxies.Blocks.biomeScanner, PlayerProxies.Blocks.biomeScanner.getUnlocalizedName());
		GameRegistry.registerTileEntity(TileEntityBiomeScanner.class, PlayerProxies.Blocks.biomeScanner.getUnlocalizedName());
	}
